...
import argparse
import os
os.environ["HF_DATASETS_CACHE"] = "/workspace/yuyang/.cache/huggingface/datasets"
import sys
...
if args.model is not None:
    ...
    download_shell = (
        "huggingface-cli download --repo-type model %s %s %s --local-dir-use-symlinks False --resume-download %s %s"
    ...
    if args.save_dir is not None:
        ...
        save_dir_option = "--local-dir %s" % save_path
    download_shell = (
        "huggingface-cli download --repo-type dataset %s %s %s --local-dir-use-symlinks False --resume-download %s %s"
